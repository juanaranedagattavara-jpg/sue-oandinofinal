...
const serviceIcons = {
  'Educación Regenerativa': (
    <svg
      className="w-12 h-12 text-sa-accent"
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
    >
          ...
          <div className="text-center mb-16">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md max-w-4xl mx-auto">
              <p className="text-lg text-sa-ink/80 leading-relaxed">
                ...
                Cada programa está adaptado a las necesidades específicas de
            ...
            {homeData.services.items.map((service, index) => (
              ...
              >
                ...
                <p className="text-sa-ink/80">
                  ...
                  social a través de metodologías participativas y
                  regenerativas.
                </p>
              </div>
            ))}
          ...
          <div className="text-center">
            <div className="bg-sa-primary rounded-2xl p-8 text-white max-w-2xl mx-auto">
              ...
              <p className="text-white/90 mb-6">
                Descubre cómo nuestros servicios pueden generar impacto real en
                tu comunidad
              </p>
              <a href="#contacto">
                <Button
                  variant="secondary"
                  size="lg"
                  className="bg-white text-sa-primary hover:bg-sa-cloud"
                >
                  Conoce Más
                </Button>
              </a>
